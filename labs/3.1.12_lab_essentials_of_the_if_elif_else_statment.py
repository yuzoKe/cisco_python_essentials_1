...
It would be good to verify if the entered year falls into the Gregorian era, and output a warning otherwise: Not within
the Gregorian calendar period. Tip: use the != and % operators.

Test your code using the data we've provided.

TEST DATA
Sample Input: 2000
Expected output1: Leap year

Sample Input: 2015
Expected output1: Common year
...
Sample Input: 1580
Expected output1: Not within the Gregorian calendar period
"""
